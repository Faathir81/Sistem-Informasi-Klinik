...
> [!NOTE]
> **Catatan Versi**: Tech stack akhir yang diputuskan adalah **Laravel 12 + Filament v4** (bukan Laravel 13) karena Filament v4 belum kompatibel penuh dengan Laravel 13. Laravel 12 (rilis Februari 2025) adalah versi terbaru yang stabil dan *production-ready* dengan dukungan Filament v4 penuh.
