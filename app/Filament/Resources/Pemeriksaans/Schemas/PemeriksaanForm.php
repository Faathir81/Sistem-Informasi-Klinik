        ...
        return $schema
            ->components([
                Section::make('Informasi Kunjungan')
                    ->description('Pilih antrean agar profil pasien dan dokter terisi otomatis.')
                    ->schema([
                    ...
                    ->columns(2)
                    ->columnSpanFull(),
                Section::make('Catatan Medis')
                    ->description('Keluhan, hasil diagnosis, dan tindakan utama pemeriksaan.')
                    ->schema([
                    ...
                    ->columns(2)
                    ->columnSpanFull(),
                Section::make('Layanan & Pembayaran')
                    ->description('Rincian tindakan berbayar dan status pembayaran pasien.')
                    ->schema([
