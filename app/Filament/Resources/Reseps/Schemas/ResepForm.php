        ...
        return $schema
            ->components([
                Section::make('Informasi Resep')
                    ->description('Hubungkan resep dengan pemeriksaan dan pantau status pengambilan.')
                    ->schema([
                ...
                Section::make('Daftar Obat')
                    ->description('Tambahkan obat, jumlah, dan aturan pakai untuk pasien.')
                    ->schema([
                        Repeater::make('details')
                            ...
                            ->schema([
                                Select::make('obat_id')
                                    ...
                                    ->getOptionLabelFromRecordUsing(fn (Obat $record): string => "{$record->nama_obat} - stok tersedia {$record->stokTersedia()} {$record->satuan}")
                                    ->searchable()
                                    ->preload()
                                    ->live()
